let functions,admin,moment,nodemailer,notifications;_8db‍.x([["default",()=>_8db‍.o]]);_8db‍.w("firebase-functions",[["*",null,function(v){functions=v}]]);_8db‍.w("firebase-admin",[["default",["admin"],function(v){admin=v}]]);_8db‍.w("moment",[["default",["moment"],function(v){moment=v}]]);_8db‍.w("nodemailer",[["default",["nodemailer"],function(v){nodemailer=v}]]);_8db‍.w("firebase-function-tools/lib/notifications",[["default",["notifications"],function(v){notifications=v}]]);
...
_8db‍.d(functions
  ...
  .onCreate((eventSnapshot, context) => {
    _8db‍.g.console.log('authType', context.authType)
    ...
    _8db‍.g.console.log('values', eventSnapshot.val())
    console.log(
